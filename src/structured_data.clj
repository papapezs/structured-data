...
(defn author->string [author]
  (let [author-name (:name author)
    ...
    (if (contains? author :birth-year) (str author-name " (" birth-year " - " death-year ")") author-name)))
...
(defn books->string [books]
  (let [many (count books)]
    (cond
      (= 0 many) "No books."
      (= 1 many) (str "1 book. " (book->string (get books 0)) ".")
      :else (str many " books. " (apply str (interpose ". " (map book->string books)))))))
